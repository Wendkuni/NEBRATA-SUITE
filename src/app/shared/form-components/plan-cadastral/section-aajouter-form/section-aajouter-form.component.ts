...
@Component({
  selector: 'app-section-aajouter-form',
  templateUrl: './section-aajouter-form.component.html',
  styleUrls: ['./section-aajouter-form.component.scss'],
  providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => SectionAAjouterFormComponent), multi: true }],
})
export class SectionAAjouterFormComponent implements ControlValueAccessor, OnInit, OnDestroy, OnChanges {
