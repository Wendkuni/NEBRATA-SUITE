...
@Component({
  selector: 'app-section-adesactive-form',
  templateUrl: './section-adesactive-form.component.html',
  styleUrls: ['./section-adesactive-form.component.scss'],
  providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => SectionADesactiveFormComponent), multi: true }],
  encapsulation: ViewEncapsulation.None,
})
export class SectionADesactiveFormComponent implements ControlValueAccessor, OnInit, OnDestroy, OnChanges {
