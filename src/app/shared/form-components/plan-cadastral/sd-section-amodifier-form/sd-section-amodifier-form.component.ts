...
import {
  ...
  FormArray, FormBuilder, Validators
} from '@angular/forms';
import {
  Section
...
@Component({
  selector: 'app-sd-section-amodifier-form',
  templateUrl: './sd-section-amodifier-form.component.html',
  styleUrls: ['./sd-section-amodifier-form.component.scss']
})
export class SdSectionAmodifierFormComponent  implements ControlValueAccessor, OnInit, OnDestroy, OnChanges{
  @Input()
  touched: boolean;
  ...
  ngOnChanges(simpleChanges: SimpleChanges) {
    ...
    if (simpleChanges['commune']&& simpleChanges['commune'].currentValue){
      this.initSection();
