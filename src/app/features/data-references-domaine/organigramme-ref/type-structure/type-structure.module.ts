...
import { FormTypeStructureComponent } from './form-type-structure/form-type-structure.component';
import {TypeStructureService} from '@sycadApp/services/data-references/organigramme/type-structure.service';


@NgModule({
  declarations: [TypeStructureComponent, FormTypeStructureComponent],
  imports: [
    CommonModule,
  ...
  providers: [TypeStructureService],
  entryComponents: [FormTypeStructureComponent]
})
