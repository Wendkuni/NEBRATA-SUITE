...
import { FormSystemImpositionComponent } from './form-system-imposition/form-system-imposition.component';

@Component({
  selector: 'app-system-imposition',
  templateUrl: './system-imposition.component.html',
  styleUrls: ['./system-imposition.component.scss']
})
export class SystemImpositionComponent extends AbstractSycadTableComponent implements OnInit {
  ...
  constructor(private _snackBar: MatSnackBar,
              ...
              private injector: Injector, public systemImpositionService: SystemImpositionService) {
    super();
  }
  ...
  public async loadComponent() {
    ...
    tableauComponent.instance.backendApiService = this.systemImpositionService;
  ...
  ngOnInit(): void {
    ...
    this.loadComponent();
    this.monTableau.typeRessource = "SystemImpositionResource";
  }

  public openFormModal(systemImpot: SystemImposition){
    let { width,height,position}=this.getCorrectWidth();
    this.dialogRef = this.dialog.open(FormSystemImpositionComponent, {
      data: systemImpot,
    ...
    this.dialogRef.afterClosed().subscribe(systemImpot => {
      if(systemImpot) {
  ...
  public dialogRef: MatDialogRef<FormSystemImpositionComponent,any>;
  ...
  public modifier(typeBatiment) {
    this.openFormModal(typeBatiment);
  }
  public supprimer(data) {
    this.systemImpositionService.delete(data.id).subscribe(
      data => {
