...
import { NatureImpotRoutingModule } from './nature-impot-routing.module';
...
@NgModule({
  declarations: [NatureImpotComponent, FormNatureImpotComponent],
  imports: [
    CommonModule,
    NatureImpotRoutingModule,
  ...
  providers: [NatureImpotService, SystemImpositionService],
  entryComponents: [FormNatureImpotComponent]
})
export class NatureImpotModule { }
