...
import { ExerciceFiscaleRoutingModule } from './exercice-fiscale-routing.module';
...
@NgModule({
  declarations: [ExerciceFiscaleComponent, FormExerciceFiscaleComponent],
  imports: [
    CommonModule,
    ExerciceFiscaleRoutingModule,
  ...
  providers: [ExerciceFiscaleService],
  entryComponents: [FormExerciceFiscaleComponent]
})
export class ExerciceFiscaleModule { }
