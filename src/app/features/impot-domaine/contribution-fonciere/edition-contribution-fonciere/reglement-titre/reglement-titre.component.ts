...
@Component({
  selector: 'app-reglement-titre',
  templateUrl: './reglement-titre.component.html',
  styleUrls: ['./reglement-titre.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ReglementTitreComponent extends TransitionContributionFonciereComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.contributionFonciereService.executer(this.formulaire.value).subscribe(data => {
      this.loadingEvent.emit(false);
        this.openSnackBar("Contribution foncière mise à jour avec succès", "OK");
