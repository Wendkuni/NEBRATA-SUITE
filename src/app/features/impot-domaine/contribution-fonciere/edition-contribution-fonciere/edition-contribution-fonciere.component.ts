...
@Component({
  selector: 'app-edition-contribution-fonciere',
  templateUrl: './edition-contribution-fonciere.component.html',
  styleUrls: ['./edition-contribution-fonciere.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EditionContributionFonciereComponent implements OnInit {
  ...
  {
    this.contributionFonciere = this.route.snapshot.data["contributionFonciere"];
