...
@Component({
  selector: 'app-saisie-exoneration',
  templateUrl: './saisie.component.html',
  styleUrls: ['./saisie.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SaisieComponent extends TransitionExonerationComponent implements OnInit {
  ...
  ngOnInit(): void {
   // console.log(this.exonerationDossier);
    ...
    this.exonerationF = this.fb.group({
      ...
      contribuable: this.exonerationDossier.exoneration.contribuable,
      natureImpot: this.exonerationDossier.exoneration.natureImpot.id,
      parcelle: this.exonerationDossier.exoneration.parcelle,
    ...
    this.formulaire.patchValue({
      ...
      exoneration: {
        ...
        modifDoc: this.exonerationDossier.exoneration.modifDoc,
        contribuable: this.exonerationDossier.exoneration.contribuable,
        natureImpot: this.exonerationDossier.exoneration.natureImpot,
        parcelle: this.exonerationDossier.exoneration.parcelle,
        categorie: this.exonerationDossier.exoneration.categorie,
        taux: this.exonerationDossier.exoneration.taux,
        montant: this.exonerationDossier.exoneration.montant,
        dateDebut: this.exonerationDossier.exoneration.dateDebut,
        dateFin: this.exonerationDossier.exoneration.dateFin,
  ...
  onSubmit() {
    ...
    let { dossier, pieces, exoneration, action, numero } = this.formulaire.value;
