...
@Component({
  selector: 'app-valider-exoneration',
  templateUrl: './valider-exoneration.component.html',
  styleUrls: ['./valider-exoneration.component.scss']
})
export class ValiderExonerationComponent extends TransitionExonerationComponent implements OnInit {
