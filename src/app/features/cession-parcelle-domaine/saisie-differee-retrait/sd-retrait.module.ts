...
import { CreationSdRetraitComponent } from './edition-sd-retrait/creation/creation-sd-retrait.component';
import { EditionSdRetraitComponent } from './edition-sd-retrait/edition-sd-retrait.component';
import { SaisieSdRetraitComponent } from './edition-sd-retrait/saisie/saisie-sd-retrait.component';
import { RetraitResolver, RetraitProcessusResolver, RetraitTransitionResolver } from './sd-retrait-resolver';
import { SdRetraitRoutingModule } from './sd-retrait-routing.module';
...
@NgModule({
  declarations: [SdRetraitComponent, EditionSdRetraitComponent,
    CreationSdRetraitComponent,
    SaisieSdRetraitComponent,
    VueSdRetraitComponent],
  imports: [
    ContribuableServicesProvidersModule,
    CommonModule,
    SdRetraitRoutingModule,
  ...
  providers: [CycleDeVieParcelleService,SdRetraitService, RetraitResolver, TransitionService, RetraitProcessusResolver, RetraitTransitionResolver, CategoriePieceService,
    ...
    CessionSourceService, ParcelleService, CommunesService, ActeursService, ContribuableService,MandatService, ArrondissementsService
    ,
    { provide: MatDialogRef, useValue: {} },
    { provide: MAT_DIALOG_DATA, useValue: { }}]
})
export class SdRetraitModule{ }
