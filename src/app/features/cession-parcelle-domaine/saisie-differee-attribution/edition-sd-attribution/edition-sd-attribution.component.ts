...
@Component({
  selector: 'app-edition-sd-attribution',
  templateUrl: './edition-sd-attribution.component.html',
  styleUrls: ['./edition-sd-attribution.component.scss']
})
export class EditionSdAttributionComponent implements OnInit {
  ...
  constructor(  private router: Router,
                ...
                public fb: FormBuilder, public attributionService: SdAttributionService)
  {
