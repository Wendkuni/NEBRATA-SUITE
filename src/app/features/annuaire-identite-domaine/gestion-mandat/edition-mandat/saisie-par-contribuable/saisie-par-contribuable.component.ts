...
export class SaisieParContribuableComponent extends TransitionMandatComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    /* if (this.mandat.documents) {
      this.mandat.documents.map((document) => {
