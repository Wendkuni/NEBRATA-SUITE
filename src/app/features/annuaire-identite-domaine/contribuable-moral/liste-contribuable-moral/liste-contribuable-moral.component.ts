...
@Component({
  selector: 'app-liste-contribuable-moral',
  templateUrl: './liste-contribuable-moral.component.html',
  styleUrls: ['./liste-contribuable-moral.component.scss']
})
export class ListeContribuableMoralComponent extends AbstractSycadTableComponent implements OnInit{
  @Input("contribuable")  contribuable=new SycadTableContext<ContribuableMoraleItem>();
  ...
  constructor(private _snackBar: MatSnackBar,
              ...
              private injector: Injector,public contribuableMoralService: ContribuableMoralService)
  {super(); }

  ngOnInit(): void {
    this.monTableau=new SycadTableMetaData("Tableau des contribuables morals",true,false);
    ...
    this.monTableau
      ...
      .pushColumn(new SycadTableColonne("regimeFiscal","Régime Fiscal",true,TypeColonne.STRING,true,""))
    ...
    this.monTableau.typeRessource="ContribuableMoraleResource";
  ...
  public async loadComponent() {
    ...
    tableauComponent.instance.backendApiService=this.contribuableMoralService;
  ...
  public modifier(contribuale) {
    this.router.navigate([`${environment.FRONTEND_ROUTES.CONTRIBUABLE_MORAL}/edition`,contribuale.guid]);
  }
  public supprimer(data) {


    this.contribuableMoralService.delete(data.guid).subscribe(
      data => {
  ...
  public onViewProfil(contribuale) {
    this.router.navigate([`${environment.FRONTEND_ROUTES.CONTRIBUABLE_VIEW_PROFIL_MORAL}`,contribuale.guid]);
  }
