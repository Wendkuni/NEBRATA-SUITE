...
@Component({
  selector: 'app-info-user-fusion',
  templateUrl: './info-user-fusion.component.html',
  styleUrls: ['./info-user-fusion.component.scss']
})
export class InfoUserFusionComponent  implements OnInit {
  ...
  guid : string;
  constructor(public profilService: UserProfilFusionService,
  ...
  ouvrirLeDossier(dossier: PlanCadastralFusionementElement){
    this.router.navigate([`${environment.FRONTEND_ROUTES.PROCESSUS_PLAN_CADASTRAL_FUSION}/view`, dossier.numero]);
  }
}
