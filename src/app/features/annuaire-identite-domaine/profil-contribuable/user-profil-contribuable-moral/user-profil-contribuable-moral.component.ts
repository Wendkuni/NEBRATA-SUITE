...
@Component({
  selector: "app-user-profil-contribuable-moral",
  templateUrl: "./user-profil-contribuable-moral.component.html",
  styleUrls: ["./user-profil-contribuable-moral.component.scss"],
})
export class UserProfilContribuableMoralComponent implements OnInit {
  constructor() {}
...
@NgModule({
  declarations: [UserProfilContribuableMoralComponent],
  imports: [CommonModule, MatDatepickerModule, GeneralGlobalSharedModule,MatIconModule,UserProfilModule, MatTabsModule, MatDataTableSharedModule,MatCardModule,MatTableModule],
  providers: [
...
export class UserProfilContribuableMoralModule {}
