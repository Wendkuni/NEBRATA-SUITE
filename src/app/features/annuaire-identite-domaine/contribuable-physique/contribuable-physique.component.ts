...
import {ContribuablePhysiqueItem} from "@sycadApp/models/data-references/contribuables/contribuable-physique.model";
import {ContribuablePhysiqueService} from '@sycadApp/services/data-references/contribuables/contribuable-physique.service';



@Component({
  selector: "app-contribuable-physique",
  templateUrl: "./contribuable-physique.component.html",
  styleUrls: ["./contribuable-physique.component.scss"],
  encapsulation: ViewEncapsulation.None
})
export class ContribuablePhysiqueComponent  implements OnInit {


  public settings: Settings;
  public context = new SycadTableContext<ContribuablePhysiqueItem>();
    ...
    merge(this.globalsearchTermSubject, this.paginator.page)
      .pipe(
        ...
        switchMap(() => {
          ...
          return this.contribuablePhysiqueService.search(this.context);
        })).subscribe(data => {
  ...
  public supprimer(data) {
    ...
    this.contribuablePhysiqueService.delete(data.guid).subscribe(
      data => {
        this.openSnackBar("Contribuable physique supprimé avec succès","OK");
        this.globalsearchTermSubject.next("");
      },
      errorResponse => {
        this.openSnackBar("Impossible de supprimer le contribuable physique","OK");
      }
    );
  }
}
