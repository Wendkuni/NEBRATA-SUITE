...
@Component({
  selector: 'app-retirer-titre-sd-delivrance-aap',
  templateUrl: './retirer-titre-sd-delivrance-aap.component.html',
  styleUrls: ['./retirer-titre-sd-delivrance-aap.component.scss']
})
export class RetirerTitreSdDelivranceAapComponent extends TransitionSdDelivranceComponent implements OnInit {
  ...
  constructor(
    ...
    this.formulaire = this.fb.group({
      ...
      documentDeSortie: this.fb.group({
        libelle: [null],
        retirerPar:  this.fb.group({
          guid: [null, Validators.compose([Validators.required])],
        }),
      }),
