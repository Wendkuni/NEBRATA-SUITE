...
@Component({
  selector: 'pc-creation-sd-delivrance-aap-par-agent',
  templateUrl: './creation-sd-delivrance-aap-par-agent.component.html',
  styleUrls: ['./creation-sd-delivrance-aap-par-agent.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CreationSdDelivranceAapParAgentComponent extends TransitionSdDelivranceComponent implements OnInit {
  ...
  onSubmit() {
   ...
   this.loadingEvent.emit(true);
    ...
    let { dossier, contribuableBeneficiaire, parcelle, documentType, pieces, documents, mandats, dateDepot, dateDemande, quittances, informationParcelle} = this.formulaire.value;
    let tmp = {contribuableBeneficiaire, parcelle, documentType, pieces, documents, mandats, dateDepot, dateDemande, quittances, informationParcelle};
