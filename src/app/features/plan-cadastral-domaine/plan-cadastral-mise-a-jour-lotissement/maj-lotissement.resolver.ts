...
@Injectable()
export class MajLotissementResolver implements Resolve<any> {

  constructor( private planCadastralService: PlanCadastralMiseAjourLotissementService,   private router: Router) {}
...
@Injectable()
export class MajLotissementTransitionResolver extends TransitionResolver  {
...
@Injectable()
export class MajLotisssementProcessusResolver extends ProcessusResolver{
  getUrl(): string {
    return  environment.FRONTEND_ROUTES.PROCESSUS_PLAN_CADASTRAL_MAJ_PLAN_CADASTRE;
  }
  constructor( public enteteDossierService: EnteteDossierService,   public router: Router) {
    super(enteteDossierService, router, 'WRKFProcessMiseAJourPlanCadastral');
