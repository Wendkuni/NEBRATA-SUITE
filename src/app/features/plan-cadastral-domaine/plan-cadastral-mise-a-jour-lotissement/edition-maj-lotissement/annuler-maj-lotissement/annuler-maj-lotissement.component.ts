...
@Component({
  selector: 'app-annuler-maj-lotissement',
  templateUrl: './annuler-maj-lotissement.component.html',
  styleUrls: ['./annuler-maj-lotissement.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class AnnulerMajLotissementComponent extends TransitionPlanCadastralMiseAJourLotissementComponent  implements OnInit {
