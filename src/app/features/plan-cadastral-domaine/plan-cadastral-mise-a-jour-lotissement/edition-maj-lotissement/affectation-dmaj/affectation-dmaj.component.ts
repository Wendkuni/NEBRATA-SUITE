...
@Component({
  selector: 'app-affectation-dmaj',
  templateUrl: './affectation-dmaj.component.html',
  styleUrls: ['./affectation-dmaj.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AffectationDmajComponent extends  TransitionPlanCadastralMiseAJourLotissementComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.majLotissement.acteurExterne) {
      ...
      Object.assign(this.acteurExterneChoisie, this.majLotissement.acteurExterne);
  ...
  onSubmit() {
    ...
    let dataPost = (this.majLotissement.acteurExterne) ? { action, numero, observation} : { acteurExterne, action, numero, observation};
