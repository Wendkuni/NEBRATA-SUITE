...
@Component({
  selector: 'app-valider-maj-lotissement',
  templateUrl: './valider-maj-lotissement.component.html',
  styleUrls: ['./valider-maj-lotissement.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class ValiderMajLotissementComponent extends TransitionPlanCadastralMiseAJourLotissementComponent  implements OnInit {
