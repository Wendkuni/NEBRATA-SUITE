...
@Component({
  selector: 'pc-rejet-saisie-amenagement',
  templateUrl: './rejet-saisie-amenagement.component.html',
  styleUrls: ['./rejet-saisie-amenagement.component.scss']
})
export class RejetSaisieAmenagementComponent extends TransitionPlanCadastralComponent<PlanCadastralAmenagementElement> implements OnInit {
