...
@Component({
  selector: 'app-valider-fusion',
  templateUrl: './valider-fusion.component.html',
  styleUrls: ['./valider-fusion.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class ValiderFusionComponent extends TransitionPlanCadastralFusionnement  implements OnInit {
