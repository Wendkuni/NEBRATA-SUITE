...
export class AffectationDmComponent extends  TransitionPlanCadastralFusionnement implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.fusion.acteurExterne) {
      ...
      Object.assign(this.acteurExterneChoisie, this.fusion.acteurExterne);
  ...
  onSubmit() {
    ...
    let dataPost = (this.fusion.acteurExterne)? { action, numero, observation}:{ acteurExterne, action, numero, observation};
