...
@Component({
  selector: 'app-edition-edmfusion',
  templateUrl: './edition-edmfusion.component.html',
  styleUrls: ['./edition-edmfusion.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EditionEDMFusionComponent extends TransitionPlanCadastralFusionnement implements OnInit {
  constructor(
  ...
  ngOnInit(): void {
    ...
    if(this.fusion.documents){
      this.fusion.documents.map(document =>{
