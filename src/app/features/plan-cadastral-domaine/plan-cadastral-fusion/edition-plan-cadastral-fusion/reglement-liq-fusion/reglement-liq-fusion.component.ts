...
@Component({
  selector: 'app-reglement-liq-fusion',
  templateUrl: './reglement-liq-fusion.component.html',
  styleUrls: ['./reglement-liq-fusion.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ReglementLiqFusionComponent extends TransitionPlanCadastralFusionnement implements OnInit {
