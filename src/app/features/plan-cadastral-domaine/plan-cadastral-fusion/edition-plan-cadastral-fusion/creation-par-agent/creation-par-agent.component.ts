...
@Component({
  selector: 'app-creation-fusionnement-par-agent',
  templateUrl: './creation-par-agent.component.html',
  styleUrls: ['./creation-par-agent.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CreationParAgentComponent extends TransitionPlanCadastralFusionnement implements OnInit {
  ...
  onSubmit() {
    ...
    let { dossier, acteurExterne, contribuableBeneficiaire, structureBeneficiaire , parcelles, pieces } = this.formulaire.value;
    let tmp = { acteurExterne,parcelles,contribuableBeneficiaire, structureBeneficiaire , pieces};
