...
@Component({
  selector: 'app-envoie-liq-fusion-vers-sintax',
  templateUrl: './envoie-liq-fusion-vers-sintax.component.html',
  styleUrls: ['./envoie-liq-fusion-vers-sintax.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EnvoieLiqFusionVersSintaxComponent  extends TransitionPlanCadastralFusionnement implements OnInit {
