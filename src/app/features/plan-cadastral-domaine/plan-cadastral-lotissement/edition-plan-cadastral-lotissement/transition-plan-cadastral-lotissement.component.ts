...
@Directive()
export class TransitionPlanCadastralLotissementComponent extends TransitionPlanCadastralComponent<PlanCadastralLotissementElement> {
          ...
          if(ilot.parcelles) {
            parcelles = ilot.parcelles.map((parcelle) => {
              return  this.fb.group({
                ...
                destination: [parcelle.destination, Validators.compose([Validators.required])],
