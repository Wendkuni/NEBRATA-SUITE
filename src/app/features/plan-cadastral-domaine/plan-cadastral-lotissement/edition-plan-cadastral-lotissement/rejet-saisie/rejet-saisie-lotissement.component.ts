...
@Component({
  selector: 'pc-rejet-saisie-lotissement',
  templateUrl: './rejet-saisie-lotissement.component.html',
  styleUrls: ['./rejet-saisie-lotissement.component.scss']
})
export class RejetSaisieLotissementComponent extends TransitionPlanCadastralComponent<PlanCadastralLotissementElement> implements OnInit {
