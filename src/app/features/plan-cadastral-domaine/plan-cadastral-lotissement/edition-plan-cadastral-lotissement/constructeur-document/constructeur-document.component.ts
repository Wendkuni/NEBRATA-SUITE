...
@Component({
  selector: 'lo-constructeur-document',
  templateUrl: './constructeur-document.component.html',
  styleUrls: ['./constructeur-document.component.scss']
})
export class ConstructeurDocumentComponent extends TransitionPlanCadastralComponent<PlanCadastralLotissementElement> implements OnInit {
