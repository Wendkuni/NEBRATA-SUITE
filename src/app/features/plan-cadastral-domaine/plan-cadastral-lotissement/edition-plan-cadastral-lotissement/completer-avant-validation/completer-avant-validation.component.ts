...
@Component({
  selector: 'pc-completer-avant-validation',
  templateUrl: './completer-avant-validation.component.html',
  styleUrls: ['./completer-avant-validation.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CompleterAvantValidationComponent extends TransitionPlanCadastralLotissementComponent implements OnInit {
