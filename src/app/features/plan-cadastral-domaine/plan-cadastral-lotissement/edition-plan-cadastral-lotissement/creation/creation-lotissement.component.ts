...
@Component({
  selector: 'pc-creation-lotissement',
  templateUrl: './creation-lotissement.component.html',
  styleUrls: ['./creation-lotissement.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class CreationLotissementComponent extends TransitionPlanCadastralLotissementComponent implements OnInit {
