...
@Component({
  selector: 'app-vue-lotissement',
  templateUrl: './vue-lotissement.component.html',
  styleUrls: ['./vue-lotissement.component.scss'],
  animations: [
...
export class VueLotissementComponent implements OnInit {
  ...
  public noOpenActions: boolean=false;
     ...
     get urlAction(){
    return `${environment.FRONTEND_ROUTES.PROCESSUS_PLAN_CADASTRAL_LOTISSEMENT}/edition`;
  }
  ...
  public displayedColumnsParcelle: string[] = ['numero', 'numeroAncien','icad','superficie','etatAttribution','etatMev',"destination","quartier","localite","zone"];
