...
@Component({
  selector: 'pc-sectionnement-completer-avant-validation',
  templateUrl: './completer-avant-validation.component.html',
  styleUrls: ['./completer-avant-validation.component.scss'],
  encapsulation:ViewEncapsulation.None
})
export class PCSecCompleterAvantValidationComponent extends TransitionPlanCadastralSectionnementComponent  implements OnInit {
