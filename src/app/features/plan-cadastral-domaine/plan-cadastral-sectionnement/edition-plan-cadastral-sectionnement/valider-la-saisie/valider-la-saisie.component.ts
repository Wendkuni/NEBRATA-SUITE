...
@Component({
  selector: 'pc-sectionnement-valider-la-saisie',
  templateUrl: './valider-la-saisie.component.html',
  styleUrls: ['./valider-la-saisie.component.scss']
})
export class PCSecValiderLaSaisieComponent extends TransitionPlanCadastralComponent<PlanCadastralSectionnementElement>  implements OnInit {
