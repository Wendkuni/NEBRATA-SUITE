...
@Component({
  selector: 'pc-sectionnement-rejeter-la-saisie',
  templateUrl: './rejeter-la-saisie.component.html',
  styleUrls: ['./rejeter-la-saisie.component.scss']
})
export class PCSecRejeterLaSaisieComponent extends TransitionPlanCadastralComponent<PlanCadastralSectionnementElement>  implements OnInit {
