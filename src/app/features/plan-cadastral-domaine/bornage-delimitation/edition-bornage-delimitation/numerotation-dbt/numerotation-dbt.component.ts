...
@Component({
  selector: 'app-numerotation-dbt',
  templateUrl: './numerotation-dbt.component.html',
  styleUrls: ['./numerotation-dbt.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NumerotationDBTComponent extends TransitionBornageDelimitationComponent  implements OnInit {
