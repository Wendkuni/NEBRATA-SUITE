...
@Component({
  selector: 'app-reglement-liq-bornage',
  templateUrl: './reglement-liq-bornage.component.html',
  styleUrls: ['./reglement-liq-bornage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ReglementLiqBornageComponent extends TransitionBornageDelimitationComponent  implements OnInit {
