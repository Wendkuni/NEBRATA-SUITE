...
@Component({
  selector: 'app-solder-liq-bornage',
  templateUrl: './solder-liq-bornage.component.html',
  styleUrls: ['./solder-liq-bornage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SolderLiqBornageComponent extends TransitionBornageDelimitationComponent implements OnInit {
