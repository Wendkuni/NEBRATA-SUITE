...
@Component({
  selector: 'app-envoie-liq-bornage-vers-sintax',
  templateUrl: './envoie-liq-bornage-vers-sintax.component.html',
  styleUrls: ['./envoie-liq-bornage-vers-sintax.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EnvoieLiqBornageVersSintaxComponent extends TransitionBornageDelimitationComponent  implements OnInit {
