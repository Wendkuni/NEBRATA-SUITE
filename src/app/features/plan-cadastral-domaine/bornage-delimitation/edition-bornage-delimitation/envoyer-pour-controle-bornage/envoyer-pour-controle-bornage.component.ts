...
@Component({
  selector: 'app-envoyer-pour-controle-bornage',
  templateUrl: './envoyer-pour-controle-bornage.component.html',
  styleUrls: ['./envoyer-pour-controle-bornage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EnvoyerPourControleBornageComponent extends TransitionBornageDelimitationComponent implements OnInit {
