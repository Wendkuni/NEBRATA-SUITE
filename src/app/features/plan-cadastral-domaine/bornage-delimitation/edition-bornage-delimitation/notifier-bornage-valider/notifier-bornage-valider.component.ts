...
@Component({
  selector: 'app-notifier-bornage-valider',
  templateUrl: './notifier-bornage-valider.component.html',
  styleUrls: ['./notifier-bornage-valider.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NotifierBornageValiderComponent extends TransitionBornageDelimitationComponent implements OnInit {
