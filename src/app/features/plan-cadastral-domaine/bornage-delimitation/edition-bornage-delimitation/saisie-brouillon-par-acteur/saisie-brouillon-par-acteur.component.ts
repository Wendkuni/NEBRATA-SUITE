...
@Component({
  selector: 'app-saisie-brouillon-par-acteur',
  templateUrl: './saisie-brouillon-par-acteur.component.html',
  styleUrls: ['./saisie-brouillon-par-acteur.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SaisieBrouillonParActeurComponent extends TransitionBornageDelimitationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formulaire.patchValue({
      ...
      parcelle:this.bornage.parcelle ? this.bornage.parcelle.id : null,
      dossier: {
  ...
  onSubmit() {
    ...
    let { dossier, contribuableBeneficiaire, structureBeneficiaire , parcelle, pieces,action, numero } = this.formulaire.value;
    let tmp = { parcelle,contribuableBeneficiaire, structureBeneficiaire , pieces,action, numero };
