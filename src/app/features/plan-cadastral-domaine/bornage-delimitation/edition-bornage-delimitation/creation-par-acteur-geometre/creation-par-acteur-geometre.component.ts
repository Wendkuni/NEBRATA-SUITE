...
@Component({
  selector: 'app-creation-bornage-delimitation-par-acteur-geometre',
  templateUrl: './creation-par-acteur-geometre.component.html',
  styleUrls: ['./creation-par-acteur-geometre.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CreationParActeurGeometreComponent extends TransitionBornageDelimitationComponent implements OnInit {
  ...
  */
  ...
  onSubmit() {
   ...
   this.loadingEvent.emit(true); 
    let { dossier, contribuableBeneficiaire, structureBeneficiaire , parcelle, pieces } = this.formulaire.value;
    let tmp = { parcelle,contribuableBeneficiaire, structureBeneficiaire , pieces};
