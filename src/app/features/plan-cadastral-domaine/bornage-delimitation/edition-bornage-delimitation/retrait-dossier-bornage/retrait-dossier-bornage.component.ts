...
@Component({
  selector: 'app-retrait-dossier-bornage',
  templateUrl: './retrait-dossier-bornage.component.html',
  styleUrls: ['./retrait-dossier-bornage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class RetraitDossierBornageComponent extends TransitionBornageDelimitationComponent implements OnInit {
