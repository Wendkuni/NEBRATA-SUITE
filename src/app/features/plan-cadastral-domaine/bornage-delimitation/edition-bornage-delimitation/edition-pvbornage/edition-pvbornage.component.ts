...
@Component({
  selector: 'app-edition-pvbornage',
  templateUrl: './edition-pvbornage.component.html',
  styleUrls: ['./edition-pvbornage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EditionPVBornageComponent extends TransitionBornageDelimitationComponent implements OnInit {
