...
@Component({
  selector: 'app-valider-bornage',
  templateUrl: './valider-bornage.component.html',
  styleUrls: ['./valider-bornage.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ValiderBornageComponent extends TransitionBornageDelimitationComponent implements OnInit {
