...
@Component({
  selector: 'app-numerotation-mocellement',
  templateUrl: './numerotation-mocellement.component.html',
  styleUrls: ['./numerotation-mocellement.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NumerotationMocellementComponent extends TransitionDomaineMorcellementComponent implements OnInit {
