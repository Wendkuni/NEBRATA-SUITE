...
@Component({
  selector: 'app-affectation-dm',
  templateUrl: './affectation-dm.component.html',
  styleUrls: ['./affectation-dm.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AffectationDMComponent extends TransitionDomaineMorcellementComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.morcellement.acteurExterne) {
      ...
      Object.assign(this.acteurExterneChoisie, this.morcellement.acteurExterne);
  ...
  onSubmit() {
    ...
    let dataPost = (this.morcellement.acteurExterne)? { action, numero,observation}:{ acteurExterne, action, numero,observation};
