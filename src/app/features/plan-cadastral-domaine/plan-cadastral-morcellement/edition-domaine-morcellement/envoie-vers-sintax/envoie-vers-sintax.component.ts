...
@Component({
  selector: 'app-morcellement-envoie-vers-sintax',
  templateUrl: './envoie-vers-sintax.component.html',
  styleUrls: ['./envoie-vers-sintax.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class EnvoieVersSintaxComponent extends TransitionDomaineMorcellementComponent implements OnInit {
