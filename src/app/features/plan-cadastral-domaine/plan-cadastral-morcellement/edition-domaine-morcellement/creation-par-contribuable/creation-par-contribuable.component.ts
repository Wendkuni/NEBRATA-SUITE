...
@Component({
  selector: 'app-creation-morcellement-par-contribuable',
  templateUrl: './creation-par-contribuable.component.html',
  styleUrls: ['./creation-par-contribuable.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CreationParContribuableComponent extends TransitionDomaineMorcellementComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,
              ...
              public mandatService: MandatService) {  super(router, dialog,_snackBar, confirmService, _adapter, mediaObserver, fb, categoriePieceService,
  morcellementService, acteurService, contribuableService, structureService,parcelleService,mandatService);
  }
  ...
  onSubmit() {
    ...
    let { dossier ,parcelles, parcelle, pieces, mandat} = this.formulaire.value;
    let mandats=[{
      id:mandat
    }];
    let tmp = { parcelle ,parcelles, pieces, mandats};
