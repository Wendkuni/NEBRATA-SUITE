...
@Component({
  selector: 'app-morcellement-solder-liquidation',
  templateUrl: './solder-liquidation.component.html',
  styleUrls: ['./solder-liquidation.component.scss']
})
export class SolderLiquidationComponent extends TransitionDomaineMorcellementComponent implements OnInit {
