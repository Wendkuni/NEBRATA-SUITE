...
@Component({
  selector: 'app-morcellement-reglement-liquidation',
  templateUrl: './reglement-liquidation.component.html',
  styleUrls: ['./reglement-liquidation.component.scss']
})
export class ReglementLiquidationComponent extends TransitionDomaineMorcellementComponent implements OnInit {
