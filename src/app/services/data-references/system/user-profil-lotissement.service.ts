...
@Injectable()
export class UserProfilLotissementService  {

    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_LOTISSEMENT;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_LOTISSEMENT;
