...
@Injectable()
export class UserProfilAmenagementService  {


    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_AMENAGEMENT;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_AMENAGEMENT;
