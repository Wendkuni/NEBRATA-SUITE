...
@Injectable()
export class UserProfilMandatService  {

    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_MANDAT;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_MANDAT;
