...
@Injectable()
export class UserProfilFusionService  {

    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_FUSION;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_FUSION;
