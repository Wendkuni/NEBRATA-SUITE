...
@Injectable()
export class UserProfilRetraitService {


    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_RETRAIT;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_RETRAIT;
