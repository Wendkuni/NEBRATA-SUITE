...
@Injectable()
export class UserProfilMutationService  {
    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_MUTATION;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_MUTATION;
