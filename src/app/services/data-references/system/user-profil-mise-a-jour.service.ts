...
@Injectable()
export class UserProfilMiseAJourService  {

    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_MISE_A_JOUR;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_MISE_A_JOUR;
