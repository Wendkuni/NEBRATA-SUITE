...
@Injectable()
export class UserProfilDemandeDocumentService {
  urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_DEMANDE_DOCUMENT;
  urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_DEMANDE_DOCUMENT;
