...
@Injectable()
export class UserProfilBornageService  {

  urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_BORNAGE;
  urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_BORNAGE;
