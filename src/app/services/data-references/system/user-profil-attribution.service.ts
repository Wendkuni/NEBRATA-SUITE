...
@Injectable()
export class UserProfilAttributionService  {

     urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_ATTRIBUTION;
     urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_ATTRIBUTION;
