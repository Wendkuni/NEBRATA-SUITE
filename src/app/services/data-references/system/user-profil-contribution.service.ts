...
@Injectable()
export class UserProfilContributionFService {

    urlMoi = environment.USERS.USER_PROFIL_DOSSIER_MOI_CONTRIBUTION;
    urlCheck = environment.USERS.USER_PROFIL_DOSSIER_CONTRIBUABLE_CONTRIBUTION;
